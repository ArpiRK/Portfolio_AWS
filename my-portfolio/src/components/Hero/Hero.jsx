    ...
    <section className="hero" id="hero">
      <div className="hero-content">
        ...
        <p className="hero-subtitle">
          9+ years designing enterprise financial platforms, 
          modernizing legacy .NET systems, and delivering 
          secure cloud-native solutions on Azure. Based in Chicago, IL.
        </p>
        ...
        <div className="hero-stats">
          ...
          <div>
            <div className="stat-number">F100</div>
